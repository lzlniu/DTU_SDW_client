...
Scenario: List of payments
	Given a successful payment of 10.0 kr from customer "cid1" to merchant "mid1"
	When the manager asks for a list of payments
	Then the list contains a payments where customer "cid1" paid 10.0 kr to merchant "mid1"
